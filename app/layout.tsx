...
export const metadata: Metadata = {
  title: 'TapFlow — Stellar Fee Sponsorship Dashboard',
  description:
    'Operator console for Stellar fee sponsorship: Horizon health, sponsor G-wallets, policies, and sponsored transactions',
};
        ...
        <footer className="border-t border-slate-200/80 dark:border-slate-800/80 mt-auto">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <p className="text-slate-500 dark:text-slate-500 text-sm text-center sm:text-left">
              TapFlow &copy; 2026 — Stellar fee sponsorship for apps
            </p>
          </div>
        </footer>
      </body>
